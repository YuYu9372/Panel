...
const DEFAULT_STATUS_TIER_CONFIG = Object.freeze({
  ...
  metrics: Object.freeze({
    cpu: Object.freeze({ unit: '%', rules: Object.freeze([
      Object.freeze({ minInclusive: 0, maxExclusive: 80, color: 'green' }),
      Object.freeze({ minInclusive: 80, maxExclusive: 90, color: 'yellow' }),
      Object.freeze({ minInclusive: 90, maxExclusive: 94, color: 'red' }),
      Object.freeze({ minInclusive: 94, maxExclusive: null, color: 'purple' }),
    ]) }),
    gpu: Object.freeze({ unit: '%', rules: Object.freeze([
      Object.freeze({ minInclusive: 0, maxExclusive: 80, color: 'green' }),
      Object.freeze({ minInclusive: 80, maxExclusive: 90, color: 'yellow' }),
      Object.freeze({ minInclusive: 90, maxExclusive: 96, color: 'red' }),
      Object.freeze({ minInclusive: 96, maxExclusive: null, color: 'purple' }),
    ]) }),
    ram: Object.freeze({ unit: '%', rules: Object.freeze([
      Object.freeze({ minInclusive: 0, maxExclusive: 70, color: 'green' }),
      Object.freeze({ minInclusive: 70, maxExclusive: 80, color: 'yellow' }),
      Object.freeze({ minInclusive: 80, maxExclusive: 90, color: 'red' }),
      Object.freeze({ minInclusive: 90, maxExclusive: null, color: 'purple' }),
    ]) }),
    temp: Object.freeze({ unit: '°C', rules: Object.freeze([
      Object.freeze({ minInclusive: 0, maxExclusive: 70, color: 'green' }),
      Object.freeze({ minInclusive: 70, maxExclusive: 80, color: 'yellow' }),
      Object.freeze({ minInclusive: 80, maxExclusive: 95, color: 'red' }),
      Object.freeze({ minInclusive: 95, maxExclusive: null, color: 'purple' }),
    ]) }),
    wifi: Object.freeze({ unit: 'ms', rules: Object.freeze([
      Object.freeze({ minInclusive: 0, maxExclusive: 25, color: 'green' }),
      Object.freeze({ minInclusive: 25, maxExclusive: 35, color: 'yellow' }),
      Object.freeze({ minInclusive: 35, maxExclusive: 45, color: 'red' }),
      Object.freeze({ minInclusive: 45, maxExclusive: null, color: 'purple' }),
    ]) }),
  }),
